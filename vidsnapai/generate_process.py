#This file looks for new folders inside user_uploads and converts them to reel if they are not already completed
import os
    ...
    while True:
     ...
     for folder in folders:
        if(folder not in done_folders):    
         ...
         create_reel(folder)    #Convert the images and audio.mp3 insider the folder to a reel
